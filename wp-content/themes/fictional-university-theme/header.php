...
<html <?php language_attributes(); ?>>
    <head>
        <!-- We give full control to wordpress for header tags -->
    ...
    <body <?php body_class(); ?>>
        <header class="site-header">
            ...
            <div class="site-header__menu group">
                ...
                <?php 
                    // Create menu in Wordpress, we need to register the menu (give the menu a name) first, then we add in what page to include in the menu, and 
                    // finally use it like here 
                    // wp_nav_menu(array(
                ...
                ?>  
                    <a href="<?php echo site_url('/my-notes'); ?>" class="btn btn--small btn--orange float-left push-right">
                        <span class="btn__text">My Notes</span>
                    </a>
